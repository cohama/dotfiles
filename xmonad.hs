...
--
myLayout = avoidStruts $ smartSpacing 5 (Mirror (reflectVert (OneBig 0.8 0.8))) ||| Simplest ||| smartSpacing 5 (reflectVert (GridRatio 1.5)) ||| smartSpacing 5 (Mirror (Tall 1 (3/100)  (1/2)))
